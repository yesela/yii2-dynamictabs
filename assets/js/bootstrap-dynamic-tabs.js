...
(function ($) {
    $.fn.bootstrapDynamicTabs = function () {
        ...
        var firstActive = $(this).find('.active a');
        if (firstActive.attr('data-url') !== undefined) {
            $(firstActive.attr('href')).load(firstActive.attr('data-url'), function (result) {
                $(firstActive).tab('show');
            })
        }
        ...
        $(this).find('a').click(function (e) {
            ...
            if (ajaxUrl !== undefined) {
                $(href).load(ajaxUrl, function (result) {
                    pane.tab('show');
                });
            } else {
            	pane.tab('show')
